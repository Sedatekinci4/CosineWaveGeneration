...
#ifndef TENSORFLOW_LITE_UTIL_COSINE_MODEL_DATA_H_
#define TENSORFLOW_LITE_UTIL_COSINE_MODEL_DATA_H_

extern const unsigned char cosine_model[];
extern const int cosine_model_len;

#endif  // TENSORFLOW_LITE_UTIL_COSINE_MODEL_DATA_H_
